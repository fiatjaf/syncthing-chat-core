...
const startListening = (st) => {
  log('will listen to events in st. current listeners: ', st.listenerCount('deviceConnected'))
  log(d)
  ...
  log('started listening for syncthing events.', st.listenerCount('deviceConnected'))
}
